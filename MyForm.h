...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// txt_prenom
			// 
			this->txt_prenom->Location = System::Drawing::Point(236, 287);
			...
			// txt_num_tel
			// 
			this->txt_num_tel->Location = System::Drawing::Point(237, 314);
			...
			// txt_date_naissance
			// 
			this->txt_date_naissance->Location = System::Drawing::Point(236, 344);
			...
			// txt_date_achat
			// 
			this->txt_date_achat->Location = System::Drawing::Point(236, 374);
			...
			this->Controls->Add(this->txt_date_achat);
			this->Controls->Add(this->txt_date_naissance);
			this->Controls->Add(this->txt_num_tel);
...
#pragma endregion
	...
	private: System::Void btn_delete_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		this->oSvc->deletesomeone(this->oMappTB->Id);
	}
